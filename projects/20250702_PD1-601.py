...
probody.set_affinity(",,", 1, "CD25", math.inf*units.nM, 4e-4/units.s)
probody.set_affinity(",,", 2, "CD132", math.inf*units.nM, 3e-3/units.s)
probody.set_internalization([",,", ",,CD132", ",CD25,", ",CD25,CD132", "PD1,,", "PD1,,CD132", "PD1,CD25,", "PD1,CD25,CD132",], 0.1/units.h)

# PD1对IL2R的CAB效应，按正常avidity计算
probody.set_affinity("PD1,,", 1, "CD25", math.inf/units.mm**2, 4e-4/units.s)
probody.set_affinity("PD1,,", 2, "CD132", math.inf/units.mm**2, 3e-3/units.s)

# IL2R对PD1的CAB效应，按正常avidity计算
probody.set_affinity(",CD25,", 0, "PD1", 500/units.mm**2, 1e-4/units.s)
probody.set_affinity(",,CD132", 0, "PD1", 500/units.mm**2, 1e-4/units.s)
probody.set_affinity(",CD25,CD132", 0, "PD1", 500/units.mm**2, 1e-4/units.s)

# 结合CD25后，对CD132亲和力增强100倍
probody.set_affinity(",CD25,", 2, "CD132", math.inf/units.mm**2, 3e-3/units.s)
probody.set_affinity("PD1,CD25,", 2, "CD132", math.inf/units.mm**2, 3e-3/units.s)

# 结合CD132后，对CD25亲和力增强10倍
probody.set_affinity(",,CD132", 1, "CD25", math.inf/units.mm**2, 4e-4/units.s)
probody.set_affinity("PD1,,CD132", 1, "CD25", math.inf/units.mm**2, 4e-4/units.s)
